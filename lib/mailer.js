  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:32px">
        ...
        <p style="color:#444">
          <a href="https://github.com/v2lojas-lgtm/v2-game-optimizer/releases/download/v1.0.0/V2-Game-Optimizer-Setup-1.0.0.exe"
        ...
        <p style="color:#444">
          <a href="https://github.com/v2lojas-lgtm/v2-game-optimizer/releases/download/v1.0.0/V2-Game-Optimizer-Guia.pdf"
             style="display:inline-block;background:#f4f4f5;color:#111;padding:10px 20px;border-radius:8px;text-decoration:none;font-weight:bold;border:1px solid #ddd">
...
async function sendLoginCodeEmail({ to, code }) {
  await resend.emails.send({
    from: process.env.RESEND_FROM,
    to,
    subject: `${code} é seu código de ativação — V2 Game Optimizer`,
    html: `
      <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:32px">
        <h2 style="color:#111">V2 Game Optimizer</h2>
        <p>Use o código abaixo para ativar o app neste computador. Ele expira em 10 minutos.</p>

        <div style="background:#f4f4f5;border-radius:8px;padding:20px;margin:24px 0;text-align:center">
          <p style="margin:0 0 8px;color:#666;font-size:13px">SEU CÓDIGO</p>
          <p style="font-size:32px;font-weight:bold;letter-spacing:6px;color:#111;margin:0">${code}</p>
        </div>

        <p style="color:#444">Volte para o V2 Game Optimizer e digite esse código na tela de ativação.</p>

        <hr style="border:none;border-top:1px solid #eee;margin:32px 0">
        <p style="color:#999;font-size:12px">Não foi você que pediu? Pode ignorar este e-mail.</p>
      </div>
    `
  })
}

module.exports = { sendLicenseEmail, sendLoginCodeEmail }
